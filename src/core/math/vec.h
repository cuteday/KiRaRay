...
namespace krr
{
	namespace math
	{
		...
		// ------------------------------------------------------------------
		template <typename T>
		struct KRR_INTERFACE vec_t<T, 1>
		{
			enum
			{
				dims = 1
		...
		// ------------------------------------------------------------------
		template <typename T>
		struct KRR_INTERFACE vec_t<T, 2>
		{
			enum
			{
				dims = 2
        ...
        paramters to kernel launches */
			inline __both__ operator dim3() const
			{
				dim3 d;
				d.x = x;
				d.y = y;
		...
		// ------------------------------------------------------------------
		template <typename T>
		struct KRR_INTERFACE vec_t<T, 3>
		{
			enum
			{
				dims = 3
		...
		// ------------------------------------------------------------------
		template <typename T>
		struct KRR_INTERFACE KRR_ALIGN(16) vec3a_t : public vec_t<T, 3>
		{
			inline vec3a_t() {}
		...
		// ------------------------------------------------------------------
		template <typename T>
		struct KRR_INTERFACE vec_t<T, 4>
		{
			enum
			{
				dims = 4
